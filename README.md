...
### Clio
This is my main server, a Lenovo M920q, with 32GB RAM. It will host all of my services, including a Samba NAS, Immich photos management, Jellyfin media server, and game servers. It is currently configured using Impermanence, so root is mounted to memory cache.
